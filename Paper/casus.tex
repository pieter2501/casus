...
\Abstract{
  Business analyse is een vakgebied dat normaliter tewerk gaat in 'klassieke' werkomgevingen.
  Tegenwoordig is agile development echter de moderne standaard, maar business analisten zijn 
  nog steeds actief. Het takenpakket van een business analist is daardoor veranderd, maar niet 
  ...
  van een goede analist kritiek voor een succesvolle bedrijfsvoering, ook bij agile.
}
